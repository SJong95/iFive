...
${nav }
   ...
   <div style="position: absolute; left: 16.5%; width: 66.5%; height: 100%; margin-top: 50px;">
		<section id="menuModifyformArea">
			<form name="menuModify" action="menuModify" method="POST" class="form-signin" enctype="multipart/form-data">
				<h2 class="form-signin-heading">메뉴 수정</h2>
				<div class="form-group">
    				<label for="RBNUM">사업자 번호</label>
   					<input class="form-control" type="text" name="RBNUM" id="RBNUM" value="${menuModifyForm.RBNUM}"readonly/>
				</div>
				<div class="form-group ">
    				<label for="MNAME">메뉴 이름</label>
   					<input class="form-control" type="text" value="${menuModifyForm.MNAME }" name="MNAME" id="MNAME" required="required"/>
				</div>
				<div class="form-group"> 
    				<label for="MPRICE">가격</label>
   					<input class="form-control" value="${menuModifyForm.MPRICE }" type="number" id="MPRICE" name="MPRICE" required="required">
				</div>
				
				<div class="form-group">
				<label for="MFile">사진 첨부</label>
					<div class="form-group form_file input-group">
  					<input class="form-control" type="text" title="첨부된 파일명" readonly placeholder="사진 첨부" id="imgName">
  					<div class="file_load input-group-addon" style="padding: 0px;">
        				...
        				<button class="btn" onclick="javascript:$('#MFile').click()" style="padding: 5px 12px;" type="button">사진 선택</button>
    				</div>
					</div>
				</div>
				<div class="form-group">
					<label for="MTMI">메뉴 설명</label>
					<input class="form-control" type="text" name="MTMI" id="MTMI" required="required" value="${menuModifyForm.MTMI }"/>
				</div>
				<div class="row">
				<div class="btn-group col-md-8 col-md-offset-3"> 
					<button class="btn btn-lg btn-info" >메뉴 수정</button>
