	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content container-fluid">
				...
				<br> <img
					style="height: 100px; width: 400px; margin-left: 38%; border-radius: 10%;"
					src="./img/notice.png"> <br>
			...
			<form action="noticeWrite" method="post" class="form-signin" >
				...
				<div class="form-group">
    				<label for="NNAME">작성자</label>
   					<input type="text" name="NNAME" id="NNAME" class="form-control" required="required" value="${sessionScope.ID }" readonly>
				...
				<div class="input-group">
					<div class="btn-group btn-group-toggle" data-toggle="buttons">
						<label class="btn btn-default">
							<input type="radio" name="NDIVI" id="NDIVI" value="0">Event
						</label>
						<label class="btn btn-default">
							<input type="radio" name="NDIVI" id="NDIVI" value="1" checked>공지사항
						</label>
					</div>
   					</div>
				</div>
				<div class="form-group">
    				<label for="NTITLE">제목</label>
   					<input type="text" name="NTITLE" id="NTITLE" class="form-control" required="required" placeholder="제목">
				</div>
				<div class="form-group">
					<label for="NCONTENT">글내용</label>
					<textarea rows="7" class="form-control" name="NCONTENT" id="NCONTENT" required placeholder="내용 작성" style="resize: none;"></textarea>
				</div>
				
				<div class="row">
				<div class="btn-group col-md-8 col-md-offset-3"> 
					<button class="btn btn-lg btn-info" >글쓰기</button>
