...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="adnoticeList?page=1"> <i class="fa fa-link"></i><span>공지사항 관리</span></a></li>
        <li><a href="adqnaList?page=1"><i class="fa fa-link"></i> <span>QnA 관리</span></a></li>
        <li><a href="resadList"><i class="fa fa-link"></i> <span>사업자 인증 관리</span></a></li>
        <li><a href="resReportList"><i class="fa fa-link"></i> <span>불량 음식점 관리</span></a></li>
        <li><a href="reviewReportList"><i class="fa fa-link"></i> <span>리뷰 신고 관리</span></a></li>
        <li><a href="main"><i class="fa fa-link"></i> <span>메인으로</span></a></li>   </ul>
      <!-- /.sidebar-menu -->
    </section> 
    <!-- /.sidebar -->  
  </aside>
  ...
  <div class="content-wrapper">
	...
	<img style="height: 100px; width: 400px; border-radius: 10%;"
		src="./img/notice.png">
		</div></div></div>
	<br>
 
	 <div style="position: absolute; left: 25.5%; width: 66.5%; height: 100%; margin-top: 50px;">
	...
	<tr>
		...
		<c:forEach var="notice" items="${noticeList}">
			...
			<tr>
				...
				<a href="adnoticeDetail?NNUM=${notice.NNUM}">${notice.NTITLE }</a></td>
				<td>관리자</td>
				<td><a>${notice.NDATE }</a>
				</td>
			</tr>
