...
${nav }
   ...
   <div style="position: absolute; left: 16.5%; width: 66.5%; height: 100%; margin-top: 50px;">
		<section id="joinformArea">
			<form name="resmodify" action="resmodify" method="post" class="form-signin">
				<h2 class="form-signin-heading">음식점 정보 수정</h2>
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="RNAME" id="RNAME" placeholder="음식점 이름" value="${resModifyForm.RNAME}"/>
				</div>
				<div class="form-group">
					<label for="RBNUM">사업자 번호</label>
					<input type="text" class="form-control" id="RBNUM" name="RBNUM" placeholder="사업자 번호" value="${resModifyForm.RBNUM}" readonly>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
    				<label for="RTEL">음식점 전화번호 </label>
   					<input type="text" class="form-control" name="RTEL" id="RTEL" placeholder="음식점 전화번호" value="${resModifyForm.RTEL}"/>
				</div>
				<div class="form-group">
