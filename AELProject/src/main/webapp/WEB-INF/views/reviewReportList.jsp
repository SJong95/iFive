	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content container-fluid">
				<h3 align="center">리뷰 신고 관리</h3>
				<br>
				<table border="1"
					style="width: 600px; height: 150px; text-align: center; margin-right: auto; margin-left: auto;">
					...
					<c:choose>
						<c:when test="${!empty reviewReportList }">
							<c:forEach var="rev" items="${reviewReportList}">
								...
								<tr>
									...
									<td>${rev.vReport}</td>
									<td><c:choose>
											<c:when test="${rev.vReport >= '5'}">
												<c:choose>
												<c:when test="${rev.vContent ne '관리자에 의해 차단되었습니다'}">
												<input type="button" class="btn btn-danger"
													onclick="javascript:location.href='reviewAdminDelete?vNum=${rev.vNum}'"
													value="차단" />
													</c:when>
												</c:choose>
											</c:when>
						...
						<c:otherwise>신고내역이 없습니다.</c:otherwise>
					</c:choose>
				</table>
